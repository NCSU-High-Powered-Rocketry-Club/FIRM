...
__NO_RETURN __STATIC_INLINE void __SW_SystemReset(void) {
    ...
    SCB->AIRCR =
        (uint32_t)((0x5FAUL << SCB_AIRCR_VECTKEY_Pos) |
                   (SCB->AIRCR &
                    SCB_AIRCR_BFHFNMINS_Msk) | /* Keep BFHFNMINS unchanged. Use this Reset function
                                                  in case your case need to keep it */
...
#define __SCB_DCACHE_LINE_SIZE                                                                     \
    32U /*!< STAR-MC1 cache line size is fixed to 32 bytes (8 words). See also register SCB_CCSIDR \
         */
