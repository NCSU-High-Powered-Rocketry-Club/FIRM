...
typedef struct {
    ...
    uint32_t HardwareFlowControl; /*!< Specifies whether the SDMMC hardware flow control is enabled
...
#define SDMMC_ERROR_CMD_CRC_FAIL                                                                   \
    0x00000001U /*!< Command response received (but CRC check failed)              */
#define SDMMC_ERROR_DATA_CRC_FAIL                                                                  \
    0x00000002U /*!< Data block sent/received (CRC check failed)                   */
#define SDMMC_ERROR_CMD_RSP_TIMEOUT                                                                \
    0x00000004U /*!< Command response timeout                                      */
#define SDMMC_ERROR_DATA_TIMEOUT                                                                   \
    0x00000008U /*!< Data timeout                                                  */
#define SDMMC_ERROR_TX_UNDERRUN                                                                    \
    0x00000010U /*!< Transmit FIFO underrun                                        */
#define SDMMC_ERROR_RX_OVERRUN                                                                     \
    0x00000020U /*!< Receive FIFO overrun                                          */
...
#define SDMMC_ERROR_ERASE_SEQ_ERR                                                                  \
    0x00000100U /*!< An error in the sequence of erase command occurs              */
#define SDMMC_ERROR_BAD_ERASE_PARAM                                                                \
    0x00000200U /*!< An invalid selection for erase groups                         */
...
#define SDMMC_ERROR_COM_CRC_FAILED                                                                 \
    0x00001000U /*!< CRC check of the previous command failed                      */
#define SDMMC_ERROR_ILLEGAL_CMD                                                                    \
    0x00002000U /*!< Command is not legal for the card state                       */
#define SDMMC_ERROR_CARD_ECC_FAILED                                                                \
    0x00004000U /*!< Card internal ECC was applied but failed to correct the data  */
#define SDMMC_ERROR_CC_ERR                                                                         \
    0x00008000U /*!< Internal card controller error                                */
...
#define SDMMC_ERROR_CID_CSD_OVERWRITE                                                              \
    0x00080000U /*!< CID/CSD overwrite error                                       */
#define SDMMC_ERROR_WP_ERASE_SKIP                                                                  \
    0x00100000U /*!< Only partial address space was erased                         */
#define SDMMC_ERROR_CARD_ECC_DISABLED                                                              \
    0x00200000U /*!< Command has been executed without using internal ECC          */
...
#define SDMMC_ERROR_AKE_SEQ_ERR                                                                    \
    0x00800000U /*!< Error in sequence of authentication                           */
#define SDMMC_ERROR_INVALID_VOLTRANGE                                                              \
    0x01000000U /*!< Error in case of invalid voltage range                        */
#define SDMMC_ERROR_ADDR_OUT_OF_RANGE                                                              \
    0x02000000U /*!< Error when addressed block is out of range                    */
...
#define SDMMC_ERROR_INVALID_PARAMETER                                                              \
    0x08000000U /*!< the used parameter is not valid                               */
...
#define SDMMC_ERROR_DMA                                                                            \
    0x40000000U /*!< Error while DMA transfer                                      */
#define SDMMC_ERROR_TIMEOUT                                                                        \
    0x80000000U /*!< Timeout error                                                 */
...
#define SDMMC_CMD_SEND_OP_COND                                                                     \
    1U /*!< Sends host capacity support information and activates the card's initialization        \
          process. */
...
#define SDMMC_CMD_HS_SEND_EXT_CSD                                                                  \
    8U /*!< Sends SD Memory Card interface condition, which includes host supply voltage           \
...
#define SDMMC_CMD_LOCK_UNLOCK                                                                      \
    42U /*!< Sets/resets the password or lock/unlock the card. The size of the data block is set   \
...
#define SDMMC_CMD_SD_APP_SET_CLR_CARD_DETECT                                                       \
    42U /*!< (ACMD42) Connect/Disconnect the 50 KOhm pull-up resistor on CD/DAT3 (pin 1) of the    \
           card  */
...
#define IS_SDIO_CLOCK_EDGE(EDGE)                                                                   \
    (((EDGE) == SDIO_CLOCK_EDGE_RISING) || ((EDGE) == SDIO_CLOCK_EDGE_FALLING))
/**
 * @}
 */
...
#define IS_SDIO_CLOCK_BYPASS(BYPASS)                                                               \
    (((BYPASS) == SDIO_CLOCK_BYPASS_DISABLE) || ((BYPASS) == SDIO_CLOCK_BYPASS_ENABLE))
/**
 * @}
 */
...
#define IS_SDIO_WAIT(WAIT)                                                                         \
    (((WAIT) == SDIO_WAIT_NO) || ((WAIT) == SDIO_WAIT_IT) || ((WAIT) == SDIO_WAIT_PEND))
/**
 * @}
 */
...
#define IS_SDIO_RESP(RESP)                                                                         \
    (((RESP) == SDIO_RESP1) || ((RESP) == SDIO_RESP2) || ((RESP) == SDIO_RESP3) ||                 \
     ((RESP) == SDIO_RESP4))
/**
 * @}
 */
...
#define SDIO_DATABLOCK_SIZE_128B                                                                   \
    (SDIO_DCTRL_DBLOCKSIZE_0 | SDIO_DCTRL_DBLOCKSIZE_1 | SDIO_DCTRL_DBLOCKSIZE_2)
...
#define SDIO_DATABLOCK_SIZE_2048B                                                                  \
    (SDIO_DCTRL_DBLOCKSIZE_0 | SDIO_DCTRL_DBLOCKSIZE_1 | SDIO_DCTRL_DBLOCKSIZE_3)
#define SDIO_DATABLOCK_SIZE_4096B (SDIO_DCTRL_DBLOCKSIZE_2 | SDIO_DCTRL_DBLOCKSIZE_3)
#define SDIO_DATABLOCK_SIZE_8192B                                                                  \
    (SDIO_DCTRL_DBLOCKSIZE_0 | SDIO_DCTRL_DBLOCKSIZE_2 | SDIO_DCTRL_DBLOCKSIZE_3)
...
#define IS_SDIO_BLOCK_SIZE(SIZE)                                                                   \
    (((SIZE) == SDIO_DATABLOCK_SIZE_1B) || ((SIZE) == SDIO_DATABLOCK_SIZE_2B) ||                   \
     ((SIZE) == SDIO_DATABLOCK_SIZE_4B) || ((SIZE) == SDIO_DATABLOCK_SIZE_8B) ||                   \
     ((SIZE) == SDIO_DATABLOCK_SIZE_16B) || ((SIZE) == SDIO_DATABLOCK_SIZE_32B) ||                 \
     ((SIZE) == SDIO_DATABLOCK_SIZE_64B) || ((SIZE) == SDIO_DATABLOCK_SIZE_128B) ||                \
     ((SIZE) == SDIO_DATABLOCK_SIZE_256B) || ((SIZE) == SDIO_DATABLOCK_SIZE_512B) ||               \
     ((SIZE) == SDIO_DATABLOCK_SIZE_1024B) || ((SIZE) == SDIO_DATABLOCK_SIZE_2048B) ||             \
     ((SIZE) == SDIO_DATABLOCK_SIZE_4096B) || ((SIZE) == SDIO_DATABLOCK_SIZE_8192B) ||             \
...
#define IS_SDIO_TRANSFER_DIR(DIR)                                                                  \
    (((DIR) == SDIO_TRANSFER_DIR_TO_CARD) || ((DIR) == SDIO_TRANSFER_DIR_TO_SDIO))
/**
 * @}
 */
...
#define IS_SDIO_TRANSFER_MODE(MODE)                                                                \
    (((MODE) == SDIO_TRANSFER_MODE_BLOCK) || ((MODE) == SDIO_TRANSFER_MODE_STREAM))
/**
 * @}
 */
...
#define IS_SDIO_READWAIT_MODE(MODE)                                                                \
    (((MODE) == SDIO_READ_WAIT_MODE_CLK) || ((MODE) == SDIO_READ_WAIT_MODE_DATA2))
/**
 * @}
 */
...
#define SDIO_STATIC_FLAGS                                                                          \
    ((uint32_t)(SDIO_FLAG_CCRCFAIL | SDIO_FLAG_DCRCFAIL | SDIO_FLAG_CTIMEOUT |                     \
                SDIO_FLAG_DTIMEOUT | SDIO_FLAG_TXUNDERR | SDIO_FLAG_RXOVERR | SDIO_FLAG_CMDREND |  \
                SDIO_FLAG_CMDSENT | SDIO_FLAG_DATAEND | SDIO_FLAG_DBCKEND | SDIO_FLAG_SDIOIT))
...
#define SDIO_STATIC_DATA_FLAGS                                                                     \
    ((uint32_t)(SDIO_FLAG_DCRCFAIL | SDIO_FLAG_DTIMEOUT | SDIO_FLAG_TXUNDERR | SDIO_FLAG_RXOVERR | \
...
#define CLKCR_CLEAR_MASK                                                                           \
    ((uint32_t)(SDIO_CLKCR_CLKDIV | SDIO_CLKCR_PWRSAV | SDIO_CLKCR_BYPASS | SDIO_CLKCR_WIDBUS |    \
                SDIO_CLKCR_NEGEDGE | SDIO_CLKCR_HWFC_EN))

/* --- DCTRL Register ---*/
/* SDIO DCTRL Clear Mask */
#define DCTRL_CLEAR_MASK                                                                           \
    ((uint32_t)(SDIO_DCTRL_DTEN | SDIO_DCTRL_DTDIR | SDIO_DCTRL_DTMODE | SDIO_DCTRL_DBLOCKSIZE))

/* --- CMD Register ---*/
/* CMD Register clear mask */
#define CMD_CLEAR_MASK                                                                             \
    ((uint32_t)(SDIO_CMD_CMDINDEX | SDIO_CMD_WAITRESP | SDIO_CMD_WAITINT | SDIO_CMD_WAITPEND |     \
...
#define __SDIO_GET_IT                                                                              \
    (__INSTANCE__, __INTERRUPT__)(((__INSTANCE__)->STA & (__INTERRUPT__)) == (__INTERRUPT__))
