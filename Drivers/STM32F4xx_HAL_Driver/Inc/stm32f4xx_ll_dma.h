...
static const uint8_t STREAM_OFFSET_TAB[] = {
    (uint8_t)(DMA1_Stream0_BASE - DMA1_BASE), (uint8_t)(DMA1_Stream1_BASE - DMA1_BASE),
    (uint8_t)(DMA1_Stream2_BASE - DMA1_BASE), (uint8_t)(DMA1_Stream3_BASE - DMA1_BASE),
    (uint8_t)(DMA1_Stream4_BASE - DMA1_BASE), (uint8_t)(DMA1_Stream5_BASE - DMA1_BASE),
    (uint8_t)(DMA1_Stream6_BASE - DMA1_BASE), (uint8_t)(DMA1_Stream7_BASE - DMA1_BASE)};
...
typedef struct {
    ...
    uint32_t FIFOMode; /*!< Specifies if the FIFO mode or Direct mode will be used for the specified
                          stream. This parameter can be a value of @ref DMA_LL_FIFOMODE
                            @note The Direct mode (FIFO mode disabled) cannot be used if the
                            memory-to-memory data transfer is configured on the selected stream

                            This feature can be modified afterwards using unitary functions @ref
                          LL_DMA_EnableFifoMode() or @ref LL_DMA_EnableFifoMode() . */
    ...
    uint32_t MemBurst; /*!< Specifies the Burst transfer configuration for the memory transfers.
                            It specifies the amount of data to be transferred in a single non
                          interruptible transaction. This parameter can be a value of @ref
                          DMA_LL_EC_MBURST
                            @note The burst mode is possible only if the address Increment mode is
                          enabled.

                            This feature can be modified afterwards using unitary function @ref
                          LL_DMA_SetMemoryBurstxfer(). */

    uint32_t PeriphBurst; /*!< Specifies the Burst transfer configuration for the peripheral
                             transfers. It specifies the amount of data to be transferred in a
                             single non interruptible transaction. This parameter can be a value of
                             @ref DMA_LL_EC_PBURST
 ...
 * @{
 */
#define LL_DMA_OFFSETSIZE_PSIZE                                                                    \
    0x00000000U /*!< Peripheral increment offset size is linked to the PSIZE */
#define LL_DMA_OFFSETSIZE_FIXEDTO4                                                                 \
    DMA_SxCR_PINCOS /*!< Peripheral increment offset size is fixed to 4 (32-bit alignment) */
/**
 * @}
 */
...
#define LL_DMA_CHANNEL_11                                                                          \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_1 | DMA_SxCR_CHSEL_0) /* Select Channel11 of DMA Instance   \
                                                              */
#define LL_DMA_CHANNEL_12                                                                          \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_2) /* Select Channel12 of DMA Instance */
#define LL_DMA_CHANNEL_13                                                                          \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_2 | DMA_SxCR_CHSEL_0) /* Select Channel13 of DMA Instance   \
                                                              */
#define LL_DMA_CHANNEL_14                                                                          \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_2 | DMA_SxCR_CHSEL_1) /* Select Channel14 of DMA Instance   \
                                                              */
#define LL_DMA_CHANNEL_15                                                                          \
    (DMA_SxCR_CHSEL_3 | DMA_SxCR_CHSEL_2 | DMA_SxCR_CHSEL_1 |                                      \
     DMA_SxCR_CHSEL_0) /* Select Channel15 of DMA Instance */
...
#define LL_DMA_PBURST_INC4                                                                         \
    DMA_SxCR_PBURST_0 /*!< Peripheral burst of 4 beats transfer configuration */
#define LL_DMA_PBURST_INC8                                                                         \
    DMA_SxCR_PBURST_1 /*!< Peripheral burst of 8 beats transfer configuration */
#define LL_DMA_PBURST_INC16                                                                        \
    (DMA_SxCR_PBURST_0 |                                                                           \
     DMA_SxCR_PBURST_1) /*!< Peripheral burst of 16 beats transfer configuration */
/**
 * @}
 */
...
#define __LL_DMA_GET_STREAM_INSTANCE(__DMA_INSTANCE__, __STREAM__)                                 \
    ((((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA1)) &&                                        \
      ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_0)))                                     \
         ? DMA1_Stream0                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA2)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_0)))                                   \
         ? DMA2_Stream0                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA1)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_1)))                                   \
         ? DMA1_Stream1                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA2)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_1)))                                   \
         ? DMA2_Stream1                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA1)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_2)))                                   \
         ? DMA1_Stream2                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA2)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_2)))                                   \
         ? DMA2_Stream2                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA1)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_3)))                                   \
         ? DMA1_Stream3                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA2)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_3)))                                   \
         ? DMA2_Stream3                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA1)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_4)))                                   \
         ? DMA1_Stream4                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA2)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_4)))                                   \
         ? DMA2_Stream4                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA1)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_5)))                                   \
         ? DMA1_Stream5                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA2)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_5)))                                   \
         ? DMA2_Stream5                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA1)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_6)))                                   \
         ? DMA1_Stream6                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA2)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_6)))                                   \
         ? DMA2_Stream6                                                                            \
     : (((uint32_t)(__DMA_INSTANCE__) == ((uint32_t)DMA1)) &&                                      \
        ((uint32_t)(__STREAM__) == ((uint32_t)LL_DMA_STREAM_7)))                                   \
         ? DMA1_Stream7                                                                            \
         : DMA2_Stream7)
...
__STATIC_INLINE void LL_DMA_EnableStream(DMA_TypeDef* DMAx, uint32_t Stream) {
    SET_BIT(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->CR,
            DMA_SxCR_EN);
}
...
__STATIC_INLINE void LL_DMA_DisableStream(DMA_TypeDef* DMAx, uint32_t Stream) {
    CLEAR_BIT(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->CR,
              DMA_SxCR_EN);
}
...
__STATIC_INLINE void LL_DMA_ConfigTransfer(DMA_TypeDef* DMAx, uint32_t Stream,
    ...
    MODIFY_REG(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->CR,
               DMA_SxCR_DIR | DMA_SxCR_CIRC | DMA_SxCR_PINC | DMA_SxCR_MINC | DMA_SxCR_PSIZE |
                   DMA_SxCR_MSIZE | DMA_SxCR_PL | DMA_SxCR_PFCTRL,
               Configuration);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetChannelSelection(DMA_TypeDef* DMAx, uint32_t Stream,
                                                uint32_t Channel) {
    MODIFY_REG(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->CR,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetMemoryBurstxfer(DMA_TypeDef* DMAx, uint32_t Stream,
                                               uint32_t Mburst) {
    MODIFY_REG(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->CR,
               DMA_SxCR_MBURST, Mburst);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetPeriphBurstxfer(DMA_TypeDef* DMAx, uint32_t Stream,
                                               uint32_t Pburst) {
    MODIFY_REG(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->CR,
               DMA_SxCR_PBURST, Pburst);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetCurrentTargetMem(DMA_TypeDef* DMAx, uint32_t Stream,
                                                uint32_t CurrentMemory) {
    MODIFY_REG(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->CR,
               DMA_SxCR_CT, CurrentMemory);
}
...
__STATIC_INLINE void LL_DMA_EnableFifoMode(DMA_TypeDef* DMAx, uint32_t Stream) {
    SET_BIT(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->FCR,
            DMA_SxFCR_DMDIS);
}
...
__STATIC_INLINE void LL_DMA_SetPeriphAddress(DMA_TypeDef* DMAx, uint32_t Stream,
    ...
    WRITE_REG(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->PAR,
              PeriphAddress);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_DMA_SetMemory1Address(DMA_TypeDef* DMAx, uint32_t Stream,
                                              uint32_t Address) {
    WRITE_REG(((DMA_Stream_TypeDef*)((uint32_t)((uint32_t)DMAx + STREAM_OFFSET_TAB[Stream])))->M1AR,
              Address);
}
