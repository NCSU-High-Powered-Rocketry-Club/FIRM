...
#if defined(SPI1) || defined(SPI2) || defined(SPI3) || defined(SPI4) || defined(SPI5) ||           \
    defined(SPI6)
...
typedef struct {
    ...
    uint32_t
        AudioFreq; /*!< Specifies the frequency selected for the I2S communication.
                      ...
                      to calculate Prescaler Linear, Parity and unitary functions @ref
                      LL_I2S_SetPrescalerLinear() and @ref LL_I2S_SetPrescalerParity() to set it.*/
 ...
 * @retval None
 */
__STATIC_INLINE void LL_I2S_ClearFlag_FRE(const SPI_TypeDef* SPIx) { LL_SPI_ClearFlag_FRE(SPIx); }
 ...
 * @note   This bit controls the generation of an interrupt when an error condition occurs (OVR, UDR
 * and FRE in I2S mode).
...
#endif /* defined (SPI1) || defined (SPI2) || defined (SPI3) || defined (SPI4) || defined (SPI5)   \
          || defined(SPI6) */
