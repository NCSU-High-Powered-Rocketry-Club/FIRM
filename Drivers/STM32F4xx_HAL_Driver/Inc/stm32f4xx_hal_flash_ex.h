...
typedef struct {
    ...
    uint32_t NbSectors; /*!< Number of sectors to be erased.
                             This parameter must be a value between 1 and (max number of sectors -
...
#define OB_WRPSTATE_DISABLE                                                                        \
    0x00000000U /*!< Disable the write protection of the desired bank 1 sectors */
#define OB_WRPSTATE_ENABLE                                                                         \
    0x00000001U /*!< Enable the write protection of the desired bank 1 sectors  */
/**
 * @}
 */
 ...
 * -----------------------*/
    ...
    defined(STM32F410Tx) || defined(STM32F410Cx) || defined(STM32F410Rx) ||                        \
    defined(STM32F411xE) || defined(STM32F412Zx) || defined(STM32F412Vx) ||                        \
    defined(STM32F412Rx) || defined(STM32F412Cx) || defined(STM32F413xx) || defined(STM32F423xx)
...
#define FLASH_BANK_BOTH ((uint32_t)FLASH_BANK_1 | FLASH_BANK_2) /*!< Bank1 and Bank2  */
    ...
    defined(STM32F417xx) || defined(STM32F401xC) || defined(STM32F401xE) ||                        \
    defined(STM32F410Tx) || defined(STM32F410Cx) || defined(STM32F410Rx) ||                        \
    defined(STM32F411xE) || defined(STM32F446xx) || defined(STM32F412Zx) ||                        \
...
/** @defgroup FLASHEx_Option_Bytes_PC_ReadWrite_Protection FLASH Option Bytes PC ReadWrite
 * Protection
 * @{
 */
/*-------------------------------- STM32F42xxx/STM32F43xxx/STM32F469xx/STM32F479xx
...
#define OB_PCROP_DESELECTED                                                                        \
    ((uint8_t)0x00) /*!< Disabled PcROP, nWPRi bits used for Write Protection on sector i */
...
#define IS_VOLTAGERANGE(RANGE)                                                                     \
    (((RANGE) == FLASH_VOLTAGE_RANGE_1) || ((RANGE) == FLASH_VOLTAGE_RANGE_2) ||                   \
     ((RANGE) == FLASH_VOLTAGE_RANGE_3) || ((RANGE) == FLASH_VOLTAGE_RANGE_4))

#define IS_WRPSTATE(VALUE) (((VALUE) == OB_WRPSTATE_DISABLE) || ((VALUE) == OB_WRPSTATE_ENABLE))

#define IS_OPTIONBYTE(VALUE)                                                                       \
    (((VALUE) <= (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_BOR)))
...
#define IS_OB_BOR_LEVEL(LEVEL)                                                                     \
    (((LEVEL) == OB_BOR_LEVEL1) || ((LEVEL) == OB_BOR_LEVEL2) || ((LEVEL) == OB_BOR_LEVEL3) ||     \
     ((LEVEL) == OB_BOR_OFF))
...
#define IS_FLASH_SECTOR(SECTOR)                                                                    \
    (((SECTOR) == FLASH_SECTOR_0) || ((SECTOR) == FLASH_SECTOR_1) ||                               \
     ((SECTOR) == FLASH_SECTOR_2) || ((SECTOR) == FLASH_SECTOR_3) || ((SECTOR) == FLASH_SECTOR_4))
#endif /* STM32F410Tx || STM32F410Cx || STM32F410Rx */
