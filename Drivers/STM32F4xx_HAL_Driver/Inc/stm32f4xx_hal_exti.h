...
#define EXTI_LINE_17                                                                               \
    (EXTI_CONFIG | 0x11u) /*!< External interrupt line 17 Connected to the RTC Alarm event */
#if defined(EXTI_IMR_IM18)
#define EXTI_LINE_18                                                                               \
    (EXTI_CONFIG | 0x12u) /*!< External interrupt line 18 Connected to the USB OTG FS Wakeup from  \
                             suspend event */
#else
...
#define EXTI_LINE_19                                                                               \
    (EXTI_CONFIG | 0x13u) /*!< External interrupt line 19 Connected to the Ethernet Wakeup event   \
                           */
#else
...
#define EXTI_LINE_20                                                                               \
    (EXTI_CONFIG | 0x14u) /*!< External interrupt line 20 Connected to the USB OTG HS (configured  \
                             in FS) Wakeup event  */
#else
...
#define EXTI_LINE_21                                                                               \
    (EXTI_CONFIG |                                                                                 \
     0x15u) /*!< External interrupt line 21 Connected to the RTC Tamper and Time Stamp events */
#define EXTI_LINE_22                                                                               \
    (EXTI_CONFIG | 0x16u) /*!< External interrupt line 22 Connected to the RTC Wakeup event */
#if defined(EXTI_IMR_IM23)
#define EXTI_LINE_23                                                                               \
    (EXTI_CONFIG |                                                                                 \
     0x17u) /*!< External interrupt line 23 Connected to the LPTIM1 asynchronous event */
#endif      /* EXTI_IMR_IM23 */
...
#define IS_EXTI_GPIO_PORT(__PORT__)                                                                \
    (((__PORT__) == EXTI_GPIOA) || ((__PORT__) == EXTI_GPIOB) || ((__PORT__) == EXTI_GPIOC) ||     \
     ((__PORT__) == EXTI_GPIOD) || ((__PORT__) == EXTI_GPIOE) || ((__PORT__) == EXTI_GPIOF) ||     \
     ((__PORT__) == EXTI_GPIOG) || ((__PORT__) == EXTI_GPIOH) || ((__PORT__) == EXTI_GPIOI) ||     \
     ((__PORT__) == EXTI_GPIOJ) || ((__PORT__) == EXTI_GPIOK))
#endif /* GPIOD */
