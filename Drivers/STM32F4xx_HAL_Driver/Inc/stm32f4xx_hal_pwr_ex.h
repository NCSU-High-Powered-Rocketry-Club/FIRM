...
#define PWR_REGULATOR_VOLTAGE_SCALE1                                                               \
    PWR_CR_VOS /* Scale 1 mode(default value at reset): the maximum value of fHCLK = 168 MHz. */
...
#define PWR_REGULATOR_VOLTAGE_SCALE3                                                               \
    PWR_CR_VOS_0 /* Scale 3 mode: the maximum value of fHCLK is 120 MHz. */
...
#define CR_ODSWEN_BB                                                                               \
    (uint32_t)(PERIPH_BB_BASE + (PWR_CR_OFFSET_BB * 32U) + (ODSWEN_BIT_NUMBER * 4U))
...
#define CR_LPLVDS_BB                                                                               \
    (uint32_t)(PERIPH_BB_BASE + (PWR_CR_OFFSET_BB * 32U) + (LPLVDS_BIT_NUMBER * 4U))
