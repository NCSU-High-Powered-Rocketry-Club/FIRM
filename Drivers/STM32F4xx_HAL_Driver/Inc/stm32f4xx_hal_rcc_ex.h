...
typedef struct {
    ...
    uint32_t PLLI2SQ; /*!< Specifies the division factor for SAI clock.
                           This parameter must be a number between Min_Data = 2 and Max_Data = 15.
                           This parameter will be used only when PLLI2S is selected as Clock Source
                         SAI */
...
typedef struct {
    ...
    uint32_t PLLSAIQ; /*!< Specifies the division factor for SAI clock.
                           This parameter must be a number between Min_Data = 2 and Max_Data = 15.
                           This parameter will be used only when PLLSAI is selected as Clock Source
                         SAI */
...
typedef struct {
    ...
    uint32_t Clk48ClockSelection; /*!< Specifies CLK48 Clock Selection this clock used OTG FS, SDIO
                                    and RNG clocks. This parameter can be a value of @ref
...
typedef struct {
    ...
    uint32_t
        I2SClockSelection; /*!< Specifies RTC Clock Source Selection.
    ...
    uint8_t
        TIMPresSelection; /*!< Specifies TIM Clock Source Selection.
 ...
 */
    ...
    defined(STM32F401xE) || defined(STM32F411xE) || defined(STM32F469xx) || defined(STM32F479xx)
...
/** @defgroup RCCEx_AHB1_Peripheral_Clock_Enable_Disable_Status AHB1 Peripheral Clock Enable Disable
 * Status
...
#define __HAL_RCC_ETH_IS_CLK_ENABLED()                                                             \
    (__HAL_RCC_ETHMAC_IS_CLK_ENABLED() && __HAL_RCC_ETHMACTX_IS_CLK_ENABLED() &&                   \
...
/** @defgroup RCCEx_AHB2_Peripheral_Clock_Enable_Disable_Status AHB2 Peripheral Clock Enable Disable
 * Status
 * @brief  Get the enable or disable status of the AHB1 peripheral clock.
 * @note   After reset, the peripheral clock (used for registers read/write access)
 *         is disabled and the application software has to enable this clock before
...
/** @defgroup RCCEx_AHB3_Peripheral_Clock_Enable_Disable_Status AHB3 Peripheral Clock Enable Disable
 * Status
...
/** @defgroup RCCEx_APB1_Peripheral_Clock_Enable_Disable_Status APB1 Peripheral Clock Enable Disable
 * Status
...
/** @defgroup RCCEx_APB2_Peripheral_Clock_Enable_Disable_Status APB2 Peripheral Clock Enable Disable
 * Status
...
/*-------STM32F412Zx || STM32F412Vx || STM32F412Rx || STM32F412Cx || STM32F413xx ||
 * STM32F423xx-------*/
#if defined(STM32F412Zx) || defined(STM32F412Vx) || defined(STM32F412Rx) ||                        \
    defined(STM32F412Cx) || defined(STM32F413xx) || defined(STM32F423xx)
/** @defgroup RCCEx_AHB1_Clock_Enable_Disable AHB1 Peripheral Clock Enable Disable
...
#define __HAL_RCC_PLL_CONFIG(__RCC_PLLSource__, __PLLM__, __PLLN__, __PLLP__, __PLLQ__, __PLLR__)  \
    (RCC->PLLCFGR = ((__RCC_PLLSource__) | (__PLLM__) | ((__PLLN__) << RCC_PLLCFGR_PLLN_Pos) |     \
                     ...
                     ((__PLLQ__) << RCC_PLLCFGR_PLLQ_Pos) | ((__PLLR__) << RCC_PLLCFGR_PLLR_Pos)))
#else
/** @brief  Macro to configure the main PLL clock source, multiplication and division factors.
 * @note   This function must be used only when the main PLL is disabled.
 * @param  __RCC_PLLSource__ specifies the PLL entry clock source.
...
#if defined(STM32F427xx) || defined(STM32F437xx) || defined(STM32F429xx) ||                        \
    defined(STM32F439xx) || defined(STM32F469xx) || defined(STM32F479xx)
/** @brief  Macro used by the SAI HAL driver to configure the PLLI2S clock multiplication and
 * division factors.
 * @note   This macro must be used only when the PLLI2S is disabled.
 * @note   PLLI2S clock source is common with the main PLL (configured in
 *         HAL_RCC_ClockConfig() API)
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_SAI1CLKSOURCE_PLLI2S: PLLI2S_Q clock divided by PLLI2SDIVQ used as SAI1
 * clock.
 *            @arg RCC_SAI1CLKSOURCE_PLLSAI: PLLISAI_Q clock divided by PLLSAIDIVQ used as SAI1
 * clock.
 *            @arg RCC_SAI1CLKSOURCE_PLLR: PLL VCO Output divided by PLLR used as SAI1 clock.
 *            @arg RCC_SAI1CLKSOURCE_EXT: External clock mapped on the I2S_CKIN pin used as SAI1
 * clock.
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_SAI2CLKSOURCE_PLLI2S: PLLI2S_Q clock divided by PLLI2SDIVQ used as SAI2
 * clock.
 *            @arg RCC_SAI2CLKSOURCE_PLLSAI: PLLISAI_Q clock divided by PLLSAIDIVQ used as SAI2
 * clock.
 *            @arg RCC_SAI2CLKSOURCE_PLLR: PLL VCO Output divided by PLLR used as SAI2 clock.
 *            @arg RCC_SAI2CLKSOURCE_PLLSRC: HSI or HSE depending from PLL Source clock used as SAI2
 * clock.
 */
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_I2SAPB1CLKSOURCE_PLLI2S: PLLI2S VCO output clock divided by PLLI2SR used as
 * I2S clock.
 *            @arg RCC_I2SAPB1CLKSOURCE_EXT: External clock mapped on the I2S_CKIN pin used as I2S
 * APB1 clock.
 ...
 * @param  __SOURCE__ specifies the SAI Block A clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_I2SAPB2CLKSOURCE_PLLI2S: PLLI2S VCO output clock divided by PLLI2SR used as
 * I2S clock.
 *            @arg RCC_I2SAPB2CLKSOURCE_EXT: External clock mapped on the I2S_CKIN pin used as I2S
 * APB2 clock.
 ...
 *            @arg RCC_CLK48CLKSOURCE_PLLSAIP: PLLSAI VCO Output divided by PLLSAIP used as CLK48
 * clock.
 */
 ...
 *            @arg RCC_SPDIFRXCLKSOURCE_PLLI2SP: PLLI2S VCO Output divided by PLLI2SP used as
 * SPDIFRX clock.
 */
...
/** @brief  Macro to configure DFSDM1 Audio clock source selection.
  * @note   This configuration is only available with
  STM32F412Zx/STM32F412Vx/STM32F412Rx/STM32F412Cx/ STM32F413xx/STM32F423xx Devices.
 ...
 * @param  __SOURCE__ specifies the SAI Block A clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_SAIACLKSOURCE_PLLI2SR: PLLI2S_R clock divided (R2) used as SAI1 Block A
 * clock.
 *            @arg RCC_SAIACLKSOURCE_EXT: External clock mapped on the I2S_CKIN pinused as SAI1
 * Block A clock.
 ...
 * @param  __SOURCE__ specifies the SAI Block B clock source.
 *         This parameter can be one of the following values:
 *            @arg RCC_SAIBCLKSOURCE_PLLI2SR: PLLI2S_R clock divided (R2) used as SAI1 Block A
 * clock.
 *            @arg RCC_SAIBCLKSOURCE_EXT: External clock mapped on the I2S_CKIN pin used as SAI1
 * Block A clock.
 ...
 *         This parameter can be one of the following values:
 *            @arg RCC_CLK48CLKSOURCE_PLLQ: PLL VCO Output divided by PLLQ used as CLK48 clock.
 *            @arg RCC_CLK48CLKSOURCE_PLLI2SQ: PLLI2S VCO Output divided by PLLI2SQ used as CLK48
 * clock.
 */
#define __HAL_RCC_CLK48_CONFIG(__SOURCE__)                                                         \
    (MODIFY_REG(RCC->DCKCFGR2, RCC_DCKCFGR2_CK48MSEL, (uint32_t)(__SOURCE__)))
...
#define RCC_PLLI2SCFGR_PLLI2SSRC_BB                                                                \
    (PERIPH_BB_BASE + (RCC_PLLI2SCFGR_OFFSET * 32U) + (RCC_PLLI2SSRC_BIT_NUMBER * 4U))
...
#define IS_RCC_FMPI2C1CLKSOURCE(SOURCE)                                                            \
    (((SOURCE) == RCC_FMPI2C1CLKSOURCE_PCLK1) || ((SOURCE) == RCC_FMPI2C1CLKSOURCE_SYSCLK) ||      \
     ((SOURCE) == RCC_FMPI2C1CLKSOURCE_HSI))

#define IS_RCC_LPTIM1CLKSOURCE(SOURCE)                                                             \
    (((SOURCE) == RCC_LPTIM1CLKSOURCE_PCLK1) || ((SOURCE) == RCC_LPTIM1CLKSOURCE_HSI) ||           \
     ((SOURCE) == RCC_LPTIM1CLKSOURCE_LSI) || ((SOURCE) == RCC_LPTIM1CLKSOURCE_LSE))

#define IS_RCC_I2SAPBCLKSOURCE(SOURCE)                                                             \
    (((SOURCE) == RCC_I2SAPBCLKSOURCE_PLLR) || ((SOURCE) == RCC_I2SAPBCLKSOURCE_EXT) ||            \
...
#define IS_RCC_SAI1CLKSOURCE(SOURCE)                                                               \
    (((SOURCE) == RCC_SAI1CLKSOURCE_PLLSAI) || ((SOURCE) == RCC_SAI1CLKSOURCE_PLLI2S) ||           \
     ((SOURCE) == RCC_SAI1CLKSOURCE_PLLR) || ((SOURCE) == RCC_SAI1CLKSOURCE_EXT))

#define IS_RCC_SAI2CLKSOURCE(SOURCE)                                                               \
    (((SOURCE) == RCC_SAI2CLKSOURCE_PLLSAI) || ((SOURCE) == RCC_SAI2CLKSOURCE_PLLI2S) ||           \
     ((SOURCE) == RCC_SAI2CLKSOURCE_PLLR) || ((SOURCE) == RCC_SAI2CLKSOURCE_PLLSRC))

#define IS_RCC_I2SAPB1CLKSOURCE(SOURCE)                                                            \
    (((SOURCE) == RCC_I2SAPB1CLKSOURCE_PLLI2S) || ((SOURCE) == RCC_I2SAPB1CLKSOURCE_EXT) ||        \
     ((SOURCE) == RCC_I2SAPB1CLKSOURCE_PLLR) || ((SOURCE) == RCC_I2SAPB1CLKSOURCE_PLLSRC))

#define IS_RCC_I2SAPB2CLKSOURCE(SOURCE)                                                            \
    (((SOURCE) == RCC_I2SAPB2CLKSOURCE_PLLI2S) || ((SOURCE) == RCC_I2SAPB2CLKSOURCE_EXT) ||        \
     ((SOURCE) == RCC_I2SAPB2CLKSOURCE_PLLR) || ((SOURCE) == RCC_I2SAPB2CLKSOURCE_PLLSRC))
...
#define IS_RCC_SPDIFRXCLKSOURCE(SOURCE)                                                            \
    (((SOURCE) == RCC_SPDIFRXCLKSOURCE_PLLR) || ((SOURCE) == RCC_SPDIFRXCLKSOURCE_PLLI2SP))
#endif /* STM32F446xx */
...
#define IS_RCC_PLLI2SCLKSOURCE(__SOURCE__)                                                         \
    (((__SOURCE__) == RCC_PLLI2SCLKSOURCE_PLLSRC) || ((__SOURCE__) == RCC_PLLI2SCLKSOURCE_EXT))
...
#define IS_RCC_CLK48CLKSOURCE(SOURCE)                                                              \
    (((SOURCE) == RCC_CLK48CLKSOURCE_PLLQ) || ((SOURCE) == RCC_CLK48CLKSOURCE_PLLI2SQ))
...
#define IS_RCC_DFSDM2CLKSOURCE(__SOURCE__)                                                         \
    (((__SOURCE__) == RCC_DFSDM2CLKSOURCE_PCLK2) || ((__SOURCE__) == RCC_DFSDM2CLKSOURCE_SYSCLK))
...
#define IS_RCC_SAIACLKSOURCE(SOURCE)                                                               \
    (((SOURCE) == RCC_SAIACLKSOURCE_PLLI2SR) || ((SOURCE) == RCC_SAIACLKSOURCE_EXT) ||             \
     ((SOURCE) == RCC_SAIACLKSOURCE_PLLR) || ((SOURCE) == RCC_SAIACLKSOURCE_PLLSRC))

#define IS_RCC_SAIBCLKSOURCE(SOURCE)                                                               \
    (((SOURCE) == RCC_SAIBCLKSOURCE_PLLI2SR) || ((SOURCE) == RCC_SAIBCLKSOURCE_EXT) ||             \
     ((SOURCE) == RCC_SAIBCLKSOURCE_PLLR) || ((SOURCE) == RCC_SAIBCLKSOURCE_PLLSRC))
