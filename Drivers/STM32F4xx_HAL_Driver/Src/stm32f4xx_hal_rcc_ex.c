...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit) {
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_RTC) == (RCC_PERIPHCLK_RTC)) {
        ...
        /* Reset the Backup domain only if the RTC Clock source selection is modified from reset
         * value */
        tmpreg1 = (RCC->BDCR & RCC_BDCR_RTCSEL);
        if ((tmpreg1 != 0x00000000U) &&
            ((tmpreg1) != (PeriphClkInit->RTCClockSelection & RCC_BDCR_RTCSEL))) {
    ...
    if ((plli2sused == 1U) || (PeriphClkInit->PeriphClockSelection == RCC_PERIPHCLK_PLLI2S)) {
        ...
        if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S_APB1) ==
            ...
            ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S_APB2) ==
              RCC_PERIPHCLK_I2S_APB2) &&
             (PeriphClkInit->I2sApb2ClockSelection == RCC_I2SAPB2CLKSOURCE_PLLI2S))) {
            /* check for Parameters */
            assert_param(IS_RCC_PLLI2SR_VALUE(PeriphClkInit->PLLI2S.PLLI2SR));

            /* Read PLLI2SP/PLLI2SQ value from PLLI2SCFGR register (this value is not needed for I2S
             * configuration) */
            plli2sp =
                ((((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SP) >> RCC_PLLI2SCFGR_PLLI2SP_Pos) + 1U)
                 << 1U);
            ...
            __HAL_RCC_PLLI2S_CONFIG(PeriphClkInit->PLLI2S.PLLI2SM, PeriphClkInit->PLLI2S.PLLI2SN,
                                    plli2sp, plli2sq, PeriphClkInit->PLLI2S.PLLI2SR);
        }
        ...
        if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) == RCC_PERIPHCLK_SAI1) &&
            ...
            /* Read PLLI2SP/PLLI2SR value from PLLI2SCFGR register (this value is not needed for SAI
             * configuration) */
            plli2sp =
                ((((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SP) >> RCC_PLLI2SCFGR_PLLI2SP_Pos) + 1U)
                 << 1U);
            ...
            __HAL_RCC_PLLI2S_CONFIG(PeriphClkInit->PLLI2S.PLLI2SM, PeriphClkInit->PLLI2S.PLLI2SN,
                                    plli2sp, PeriphClkInit->PLLI2S.PLLI2SQ, plli2sr);
        ...
        if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SPDIFRX) ==
            ...
            /* Read PLLI2SR value from PLLI2SCFGR register (this value is not need for SAI
             * configuration) */
            plli2sq =
                ((((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SP) >> RCC_PLLI2SCFGR_PLLI2SP_Pos) + 1U)
                 << 1U);
        ...
        if ((PeriphClkInit->PeriphClockSelection & RCC_PERIPHCLK_PLLI2S) == RCC_PERIPHCLK_PLLI2S) {
            ...
            /* PLLI2S_VCO = f(VCO clock) = f(PLLI2S clock input) * (PLLI2SN/PLLI2SM) */
            __HAL_RCC_PLLI2S_CONFIG(PeriphClkInit->PLLI2S.PLLI2SM, PeriphClkInit->PLLI2S.PLLI2SN,
                                    PeriphClkInit->PLLI2S.PLLI2SP, PeriphClkInit->PLLI2S.PLLI2SQ,
    ...
    /* PLLSAI is configured when a peripheral will use it as source clock : SAI1, SAI2, CLK48 or
     * SDIO */
    if (pllsaiused == 1U) {
        ...
        if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI1) == RCC_PERIPHCLK_SAI1) &&
            ...
            /* Read PLLSAIP value from PLLSAICFGR register (this value is not needed for SAI
             * configuration) */
            pllsaip =
                ((((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIP) >> RCC_PLLSAICFGR_PLLSAIP_Pos) + 1U)
                 << 1U);
            /* PLLSAI_VCO Input  = PLL_SOURCE/PLLM */
            /* PLLSAI_VCO Output = PLLSAI_VCO Input * PLLSAIN */
            /* SAI_CLK(first level) = PLLSAI_VCO Output/PLLSAIQ */
            __HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIM, PeriphClkInit->PLLSAI.PLLSAIN,
                                    pllsaip, PeriphClkInit->PLLSAI.PLLSAIQ, 0U);
        ...
        if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_CLK48) ==
            ...
            /* Read PLLSAIQ value from PLLI2SCFGR register (this value is not need for SAI
             * configuration) */
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit) {
    ...
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_I2S_APB1 | RCC_PERIPHCLK_I2S_APB2 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SAI2 |
        RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_RTC | RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_FMPI2C1 |
    ...
    PeriphClkInit->PLLI2S.PLLI2SP =
        (uint32_t)((((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SP) >> RCC_PLLI2SCFGR_PLLI2SP_Pos) + 1U)
                   << 1U);
    ...
    PeriphClkInit->PLLSAI.PLLSAIP =
        (uint32_t)((((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIP) >> RCC_PLLSAICFGR_PLLSAIP_Pos) + 1U)
                   << 1U);
    ...
    PeriphClkInit->PLLI2SDivQ =
        (uint32_t)((RCC->DCKCFGR & RCC_DCKCFGR_PLLI2SDIVQ) >> RCC_DCKCFGR_PLLI2SDIVQ_Pos);
    PeriphClkInit->PLLSAIDivQ =
        (uint32_t)((RCC->DCKCFGR & RCC_DCKCFGR_PLLSAIDIVQ) >> RCC_DCKCFGR_PLLSAIDIVQ_Pos);
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk) {
    ...
    case RCC_PERIPHCLK_I2S_APB1: {
        ...
        switch (srcclk) {
        /* Check if I2S clock selection is External clock mapped on the I2S_CKIN pin used as I2S
         * clock */
        ...
        /* Check if I2S clock selection is PLLI2S VCO output clock divided by PLLI2SR used as I2S
         * clock */
        case RCC_I2SAPB1CLKSOURCE_PLLI2S: {
            ...
            if ((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSE) {
                ...
                vcoinput =
                    (uint32_t)(HSE_VALUE / (uint32_t)(RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SM));
            } else {
                /* Get the I2S source clock value */
                vcoinput =
                    (uint32_t)(HSI_VALUE / (uint32_t)(RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SM));
            }

            /* PLLI2S_VCO Output = PLLI2S_VCO Input * PLLI2SN */
            vcooutput = (uint32_t)(vcoinput * (((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SN) >> 6U) &
                                               (RCC_PLLI2SCFGR_PLLI2SN >> 6U)));
            /* I2S_CLK = PLLI2S_VCO Output/PLLI2SR */
            frequency =
                (uint32_t)(vcooutput / (((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SR) >> 28U) &
        ...
        case RCC_I2SAPB1CLKSOURCE_PLLR: {
            ...
            /* PLL_VCO Output = PLL_VCO Input * PLLN */
            vcooutput = (uint32_t)(vcoinput * (((RCC->PLLCFGR & RCC_PLLCFGR_PLLN) >> 6U) &
                                               (RCC_PLLCFGR_PLLN >> 6U)));
            /* I2S_CLK = PLL_VCO Output/PLLR */
            frequency = (uint32_t)(vcooutput / (((RCC->PLLCFGR & RCC_PLLCFGR_PLLR) >> 28U) &
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit) {
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_I2S) == RCC_PERIPHCLK_I2S) ||
        ...
        if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLI2S) ==
            (RCC_PERIPHCLK_SAI_PLLI2S)) {
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLSAI) ==
        ...
        if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLSAI) ==
            ...
            pllsaip =
                ((((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIP) >> RCC_PLLSAICFGR_PLLSAIP_Pos) + 1U)
                 << 1U);
            /* Read PLLSAIR value from PLLSAICFGR register (this value is not need for SAI
             * configuration) */
            pllsair = ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIR) >> RCC_PLLSAICFGR_PLLSAIR_Pos);
            /* PLLSAI_VCO Input  = PLL_SOURCE/PLLM */
            /* PLLSAI_VCO Output = PLLSAI_VCO Input * PLLSAIN */
            /* SAI_CLK(first level) = PLLSAI_VCO Output/PLLSAIQ */
            __HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIN, pllsaip,
                                    PeriphClkInit->PLLSAI.PLLSAIQ, pllsair);
            /* SAI_CLK_x = SAI_CLK(first level)/PLLSAIDIVQ */
            __HAL_RCC_PLLSAI_PLLSAICLKDIVQ_CONFIG(PeriphClkInit->PLLSAIDivQ);
        }
        ...
        if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LTDC) == (RCC_PERIPHCLK_LTDC)) {
            ...
            pllsaip =
                ((((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIP) >> RCC_PLLSAICFGR_PLLSAIP_Pos) + 1U)
                 << 1U);
            /* Read PLLSAIQ value from PLLSAICFGR register (this value is not need for SAI
             * configuration) */
            pllsaiq = ((RCC->PLLSAICFGR & RCC_PLLSAICFGR_PLLSAIQ) >> RCC_PLLSAICFGR_PLLSAIQ_Pos);
            /* PLLSAI_VCO Input  = PLL_SOURCE/PLLM */
            /* PLLSAI_VCO Output = PLLSAI_VCO Input * PLLSAIN */
            /* LTDC_CLK(first level) = PLLSAI_VCO Output/PLLSAIR */
            __HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIN, pllsaip, pllsaiq,
        ...
        if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_CLK48) ==
            ...
            __HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIN, PeriphClkInit->PLLSAI.PLLSAIP,
                                    pllsaiq, pllsair);
        }
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit) {
    ...
    if ((plli2sused == 1U) || (PeriphClkInit->PeriphClockSelection == RCC_PERIPHCLK_PLLI2S)) {
        ...
        if (((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAIA) == RCC_PERIPHCLK_SAIA) &&
            ...
            /* Read PLLI2SQ value from PLLI2SCFGR register (this value is not needed for SAI
             * configuration) */
            plli2sq = ((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SQ) >> RCC_PLLI2SCFGR_PLLI2SQ_Pos);
            /* Configure the PLLI2S division factors */
            /* PLLI2S_VCO Input  = PLL_SOURCE/PLLI2SM */
            ...
            /* SAI_CLK(first level) = PLLI2S_VCO Output/PLLI2SQ */
            __HAL_RCC_PLLI2S_CONFIG(PeriphClkInit->PLLI2S.PLLI2SM, PeriphClkInit->PLLI2S.PLLI2SN,
                                    plli2sq, PeriphClkInit->PLLI2S.PLLI2SR);
    ...
    if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DFSDM2_AUDIO) ==
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit) {
...
#if defined(STM32F413xx) || defined(STM32F423xx)
    PeriphClkInit->PeriphClockSelection =
        RCC_PERIPHCLK_I2S_APB1 | RCC_PERIPHCLK_I2S_APB2 | RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_RTC |
        RCC_PERIPHCLK_FMPI2C1 | RCC_PERIPHCLK_CLK48 | RCC_PERIPHCLK_SDIO | RCC_PERIPHCLK_DFSDM1 |
        RCC_PERIPHCLK_DFSDM1_AUDIO | RCC_PERIPHCLK_DFSDM2 | RCC_PERIPHCLK_DFSDM2_AUDIO |
        RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_SAIA | RCC_PERIPHCLK_SAIB;
    ...
    PeriphClkInit->PLLI2SDivR =
        (uint32_t)((RCC->DCKCFGR & RCC_DCKCFGR_PLLI2SDIVR) >> RCC_DCKCFGR_PLLI2SDIVR_Pos);
    PeriphClkInit->PLLDivR =
        (uint32_t)((RCC->DCKCFGR & RCC_DCKCFGR_PLLDIVR) >> RCC_DCKCFGR_PLLDIVR_Pos);
#endif /* STM32F413xx || STM32F423xx */
    ...
    case RCC_PERIPHCLK_I2S_APB1: {
        ...
        case RCC_I2SAPB1CLKSOURCE_PLLI2S: {
            if ((RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SSRC) == RCC_PLLI2SCFGR_PLLI2SSRC) {
                /* Get the I2S source clock value */
                vcoinput = (uint32_t)(EXTERNAL_CLOCK_VALUE /
                                      (uint32_t)(RCC->PLLI2SCFGR & RCC_PLLI2SCFGR_PLLI2SM));
            } else {
                /* Configure the PLLI2S division factor */
                /* PLLI2S_VCO Input  = PLL_SOURCE/PLLI2SM */
                if ((RCC->PLLCFGR & RCC_PLLCFGR_PLLSRC) == RCC_PLLSOURCE_HSE) {
...
/**
 * @brief  Initializes the RCC extended peripherals clocks according to the specified parameters in
 * the RCC_PeriphCLKInitTypeDef.
 * @param  PeriphClkInit pointer to an RCC_PeriphCLKInitTypeDef structure that
 *         contains the configuration information for the Extended Peripherals clocks(I2S and RTC
 * clocks).
 *
 * @note   A caution to be taken when HAL_RCCEx_PeriphCLKConfig() is used to select RTC clock
 * selection, in this case the Reset of Backup domain will be applied in order to modify the RTC
 * Clock source as consequence all backup domain (RTC and RCC_BDCR register expect BKPSRAM) will be
 * reset
 *
 * @retval HAL status
 */
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef* PeriphClkInit) {
    ...
    if ((((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLSAI) ==
        ...
        if (((PeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_SAI_PLLSAI) ==
            ...
            /* PLLSAI_VCO Output = PLLSAI_VCO Input * PLLSAIN */
            /* SAI_CLK(first level) = PLLSAI_VCO Output/PLLSAIQ */
            __HAL_RCC_PLLSAI_CONFIG(PeriphClkInit->PLLSAI.PLLSAIN, PeriphClkInit->PLLSAI.PLLSAIQ,
                                    tmpreg1);
            /* SAI_CLK_x = SAI_CLK(first level)/PLLSAIDIVQ */
            __HAL_RCC_PLLSAI_PLLSAICLKDIVQ_CONFIG(PeriphClkInit->PLLSAIDivQ);
        }
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint32_t PeriphClk) {
    ...
    defined(STM32F417xx) || defined(STM32F401xC) || defined(STM32F401xE) || defined(STM32F411xE)
/**
 * @brief  Initializes the RCC extended peripherals clocks according to the specified parameters in
 * the RCC_PeriphCLKInitTypeDef.
 * @param  PeriphClkInit pointer to an RCC_PeriphCLKInitTypeDef structure that
 ...
 * STM32F410xx/STM32F411xx/STM32F446xx/STM32F469xx/STM32F479xx/STM32F412Zx/STM32F412Vx/STM32F412Rx/STM32F412Cx
 * devices.
 *
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLI2S(RCC_PLLI2SInitTypeDef* PLLI2SInit) {
    ...
    __HAL_RCC_PLLI2S_CONFIG(PLLI2SInit->PLLI2SM, PLLI2SInit->PLLI2SN, PLLI2SInit->PLLI2SP,
    ...
    /* I2SQCLK = PLLI2S_VCO / PLLI2SQ */
    /* I2SRCLK = PLLI2S_VCO / PLLI2SR */
    __HAL_RCC_PLLI2S_CONFIG(PLLI2SInit->PLLI2SM, PLLI2SInit->PLLI2SN, PLLI2SInit->PLLI2SQ,
                            PLLI2SInit->PLLI2SR);
...
HAL_StatusTypeDef HAL_RCCEx_EnablePLLSAI(RCC_PLLSAIInitTypeDef* PLLSAIInit) {
    ...
    __HAL_RCC_PLLSAI_CONFIG(PLLSAIInit->PLLSAIM, PLLSAIInit->PLLSAIN, PLLSAIInit->PLLSAIP,
                            PLLSAIInit->PLLSAIQ, 0U);
...
HAL_StatusTypeDef HAL_RCC_DeInit(void) {
    ...
    RCC->PLLCFGR = RCC_PLLCFGR_PLLR_0 | RCC_PLLCFGR_PLLR_1 | RCC_PLLCFGR_PLLR_2 |
...
#endif /* STM32F412Cx || STM32F412Rx || STM32F412Vx || STM32F412Zx || STM32F413xx || STM32F423xx   \
    ...
    defined(STM32F415xx) || defined(STM32F407xx) || defined(STM32F417xx)
    RCC->PLLI2SCFGR =
...
#elif defined(STM32F411xE)
    RCC->PLLI2SCFGR = RCC_PLLI2SCFGR_PLLI2SM_4 | RCC_PLLI2SCFGR_PLLI2SN_6 |
                      RCC_PLLI2SCFGR_PLLI2SN_7 | RCC_PLLI2SCFGR_PLLI2SR_1;
#endif /* STM32F412Cx || STM32F412Rx || STM32F412Vx || STM32F412Zx || STM32F413xx || STM32F423xx   \
          || STM32F446xx */
    ...
    RCC->PLLSAICFGR = RCC_PLLSAICFGR_PLLSAIN_6 | RCC_PLLSAICFGR_PLLSAIN_7 |
                      RCC_PLLSAICFGR_PLLSAIQ_2 | RCC_PLLSAICFGR_PLLSAIR_1;
    ...
    CLEAR_BIT(RCC->CIR, RCC_CIR_LSIRDYIE | RCC_CIR_LSERDYIE | RCC_CIR_HSIRDYIE | RCC_CIR_HSERDYIE |
                            RCC_CIR_PLLRDYIE);
    ...
    SET_BIT(RCC->CIR, RCC_CIR_LSIRDYC | RCC_CIR_LSERDYC | RCC_CIR_HSIRDYC | RCC_CIR_HSERDYC |
                          RCC_CIR_PLLRDYC | RCC_CIR_CSSC);
 ...
 * STM32F410xx/STM32F446xx/STM32F469xx/STM32F479xx/STM32F412Zx/STM32F412Vx/STM32F412Rx/STM32F412Cx
 * devices
 * @retval HAL status
 */
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef* RCC_OscInitStruct) {
    ...
    RCC_OscInitStruct->PLL.PLLN =
        (uint32_t)((RCC->PLLCFGR & RCC_PLLCFGR_PLLN) >> RCC_PLLCFGR_PLLN_Pos);
    RCC_OscInitStruct->PLL.PLLP =
        (uint32_t)((((RCC->PLLCFGR & RCC_PLLCFGR_PLLP) + RCC_PLLCFGR_PLLP_0) << 1U) >>
                   RCC_PLLCFGR_PLLP_Pos);
    RCC_OscInitStruct->PLL.PLLQ =
        (uint32_t)((RCC->PLLCFGR & RCC_PLLCFGR_PLLQ) >> RCC_PLLCFGR_PLLQ_Pos);
    RCC_OscInitStruct->PLL.PLLR =
        (uint32_t)((RCC->PLLCFGR & RCC_PLLCFGR_PLLR) >> RCC_PLLCFGR_PLLR_Pos);
}
