...
static HAL_StatusTypeDef FLASH_OB_EnablePCROP(uint32_t SectorBank1, uint32_t SectorBank2,
                                              uint32_t Banks);
static HAL_StatusTypeDef FLASH_OB_DisablePCROP(uint32_t SectorBank1, uint32_t SectorBank2,
                                               uint32_t Banks);
...
HAL_StatusTypeDef HAL_FLASHEx_AdvOBProgram(FLASH_AdvOBProgramInitTypeDef* pAdvOBInit) {
    ...
    defined(STM32F412Rx) || defined(STM32F412Cx) || defined(STM32F413xx) || defined(STM32F423xx)
            ...
            status = FLASH_OB_EnablePCROP(pAdvOBInit->SectorsBank1, pAdvOBInit->SectorsBank2,
                                          pAdvOBInit->Banks);
#endif /* STM32F401xC || STM32F401xE || STM32F410xx || STM32F411xE || STM32F446xx || STM32F412Zx   \
          || STM32F412Vx || STM32F412Rx || STM32F412Cx || STM32F413xx || STM32F423xx */
        } else {
 ...
 * @note   Read a protected sector will set RDERR Flag and write a protected sector will set WRPERR
 * Flag
 * @note   This function can be used only for
 * STM32F42xxx/STM32F43xxx/STM32F401xx/STM32F411xx/STM32F446xx/
 ...
 *            @arg FLASH_VOLTAGE_RANGE_4: when the device voltage range is 2.7V to 3.6V + External
 * Vpp, the operation will be done by double word (64-bit)
 *
