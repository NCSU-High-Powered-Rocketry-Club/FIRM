...
void test_mmc5983ma_convert_packet_normal_values(void) {
    ...
    // Z raw = -41751 -> magnetic_field_z = (-41751 - 131072) / (131072/800) = ~-1054.8
    ...
    TEST_ASSERT_FLOAT_WITHIN(1e-6, -800.0F, ret_packet.magnetic_field_y);
    TEST_ASSERT_FLOAT_WITHIN(1e-6, ((-41751.0F - 131072.0F) / (131072.0F / 800.0F)), ret_packet.magnetic_field_z);
}
