 ...
 *
 * @note Sets ODR to 1280, data ready to INT1 (Active Low), Disables FIFO, disables High and Low pass Filters,  -
 *        Turns off oustosleep and linkloop, sets chip to low noise operation.  
 * 
